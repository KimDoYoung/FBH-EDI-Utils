...
namespace EdiName.Common
{
    public static class ExcelExtension
    {
        ...
        public static void SetCell(this Excel.Worksheet workSheet, int row, string col, object o)
        {
            int iCol = GetCol(col);
            workSheet.Cells[row, iCol] = o;
        }
        public static void SetCell(this Excel.Worksheet workSheet, int row, string col, object o, string numberFormat)
        {
            int iCol = GetCol(col);
            workSheet.Cells[row, iCol].NumberFormat = numberFormat;
            workSheet.Cells[row, iCol] = o;
        }
