...
{
    public static class AllowanceCodeTable
    {
        public static string[,] codes = new string[,]{
            ...
            {"AFEE", "FeePercentage or fixed fee an organization charges for services"},
            {"ALPT", "Port Changes"},
            {"B000", "Central Buy"},
            {"B010", "Cents Off"},
            {"B015", "Bop SheetA cardboard pallet"},
            ...
            {"D015", "DunnageLoose materials used around a cargo to prevent damage or padding in a shipping container to protect contents against breakage"},
            ...
            {"D450", "Grouped ItemsIndicates the pricing for this line is related to the pricing of some other item either in this transaction or some prior transaction(s)"},
            ...
            {"H730", "Tax - Local Sales TaxAll applicable sales taxes by taxing authorities below the State level"},
        ...
        public static string findCode(string desc)
        {
            ...
            {
                string code = codes[i,0];
                string name = codes[i, 1].ToLower();
