...
{
    public class WarehouseShippingOrder945
    {
        ...
        public List<WarehouseShippingOrder945Detail> Details { get; set; }
        public WarehouseShippingOrder945()
        {
            Details = new List<WarehouseShippingOrder945Detail>();
        }
